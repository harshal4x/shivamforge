...
//   { id: 'oil-and-gas', name: 'Oil & Gas' },
//   { id: 'defense', name: 'Defense' },
//   { id: 'power-transmission', name: 'Power Transmission' },
//   { id: 'cnc-machined', name: 'CNC Machined' },
// ];
...
export default function ProductForm() {
  ...
  return (
    ...
    <div className="bg-white dark:bg-forge-gray rounded-xl shadow-sm p-6">
      <input type='text'  placeholder="Add New Catagory" onChange={(e)=>setcatagorytext(e.target.value)} style={{color:"black" , padding:"10px",borderRadius:"10px"}}></input>
      <Button onClick={addCatagoryHandler}>Add new catagory</Button>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Enter product name" {...field} className="forge-input" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
